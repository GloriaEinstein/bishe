...
import { createNotification, getNotifications, markNotificationAsRead, sendWarning } from '../controllers/notificationController.js';
...
router.post('/send-warning', authMiddleware, sendWarning);
